...
public class recherche extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        r5.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				r1.setChecked(false);r2.setChecked(false);r3.setChecked(false);r4.setChecked(false);r4.setChecked(false);
			}});
        ...
        valider1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				if (s1.equals("")){ Toast.makeText(recherche.this,"La case est vide \n Veillez la remplire SVP",100 ).show();}
			        ...
			        if (c.getCount() == 0){Toast.makeText(recherche.this,"Le nom que vouz avez entrez ne correspont à aucun pays ",100 ).show();}
			        //c.moveToFirst();
			        ...
			        if(r2.isChecked()){
				        ...
				        if (c1.getCount() == 0){Toast.makeText(recherche.this,"Le nom que vouz avez entrez ne correspont à aucun pays ",100 ).show();}
				        //c.moveToFirst();
				        else{go.setVisibility(Button.VISIBLE);
						int i=0;
				        ...
				        if(r3.isChecked()){
					        ...
					        if (c2.getCount() == 0){Toast.makeText(recherche.this,"Le nom que vouz avez entrez ne correspont à aucun pays ",100 ).show();}
					        //c.moveToFirst();
					        else{go.setVisibility(Button.VISIBLE);
							int i=0;
			...
			public void onClick(View v) {
				...
				if (s1.equals("")){ Toast.makeText(recherche.this,"La case est vide \n Veillez la remplire SVP",100 ).show();}
			        ...
			        if(r2.isChecked()){
				        ...
				        if (c1.getCount() == 0){Toast.makeText(recherche.this,"Le nom que vouz avez entrez ne correspont à aucune capitale ",100 ).show();}
				        //c.moveToFirst();
				        else{go.setVisibility(Button.VISIBLE);
						int i=0;
				        ...
				        if(r3.isChecked()){
					        ...
					        if (c2.getCount() == 0){Toast.makeText(recherche.this,"Le nom que vouz avez entrez ne correspont à aucune capitale ",100 ).show();}
					        //c.moveToFirst();
					        else{go.setVisibility(Button.VISIBLE);
					        int i=0;
