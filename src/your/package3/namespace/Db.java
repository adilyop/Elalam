...
public class Db {
    private static String DB_DIR = "/data/data/your.package3.namespace/databases/";
	...
	public Cursor findPaysAmerique(String a){		
		Cursor c=db.query("datapays", new String[]{"NOM"}, "NOM like "+"'%"+a+"%' and CONTINENT like 'Amèrique'", null, null, null, null);
		return c;
	}
	
	public Cursor findPaysOceanie(String a){		
		Cursor c=db.query("datapays", new String[]{"NOM"}, "NOM like "+"'%"+a+"%' and CONTINENT like 'Océanie'", null, null, null, null);
		return c;
	}
	...
	public Cursor findCapAmerique(String a){		
		Cursor c=db.query("datapays", new String[]{"CAPITALE "}, "CAPITALE like "+"'%"+a+"%' and CONTINENT like 'Amèrique'", null, null, null, null);
		return c;
	}
